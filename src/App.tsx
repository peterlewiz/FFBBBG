  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        {/* Playoff odds moved onto this page - keep old paths alive. */}
        <Route path="playoff-odds" element={<Navigate to="/odds" replace />} />
        <Route path="elo" element={<Navigate to="/odds" replace />} />
